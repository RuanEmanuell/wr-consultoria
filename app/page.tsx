          ...
          <div className="h-fit w-full" id="screen-1">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 pb-20">
              <section className="border-2 rounded min-h-80 p-4 m-2 flex flex-col align-center">
                <h4 className="font-semibold text-3xl text-center">📊</h4>
                <h4 className="font-semibold text-3xl text-center mb-4">Gestão eficiente</h4>
              ...
              <section className="border-2 rounded min-h-80 p-4 m-2 flex flex-col align-center">
                <h4 className="font-semibold text-3xl text-center">🏥</h4>
                <h4 className="font-semibold text-3xl text-center mb-4">Saúde Corporativa</h4>
              ...
              <section className="border-2 rounded min-h-80 p-4 m-2 flex flex-col align-center">
                <h4 className="font-semibold text-3xl text-center">🧠</h4>
                <h4 className="font-semibold text-3xl text-center mb-4">Neurociência nos Negócios</h4>
